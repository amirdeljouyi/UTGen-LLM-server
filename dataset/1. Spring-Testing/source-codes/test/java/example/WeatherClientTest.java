...
public class WeatherClientTest {
    ...
    public void fetchWeatherTest()  throws Exception {
		given(restTemplate.getForObject("https://api.openweathermap.org/data/2.5/weather?q=Hamburg,de&appid=1254aa0ef471380373193a60dd589e35", WeatherResponse.class))
                .willReturn(new WeatherResponse("Clouds", "few clouds"));
